...
<nav>
    <ul>
      ...
      <li><a href="http://localhost/Library/books.php">Add Books</a></li>
...
<?php
        ...
        if (isset($_POST['submit1'])) {
            ...
            WHERE l.student_id IS NULL AND s.batch='$batch' AND s.section='$section' and s.department_id= '$department'";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO library (student_id, username, password) 
